                            ...
                            {isSignup ? (
                                <form onSubmit={handleSignupSubmit} className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-center mt-2 text-gray-500 dark:text-gray-400">Have a referral? Enter your friend's username to get a <span className="font-bold text-accent-600 dark:text-accent-400">200 Rs</span> bonus!</p>
                                    </div>
